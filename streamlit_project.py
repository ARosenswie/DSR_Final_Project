...
st.subheader("Within this application, we employ a Large Language Model from OpenAI. Provided is the analysis of medical question and answer pairs (insert amount here).")

# proivde a citation for the data sources with hyperlinks
